...
class StatisticsLibView(tk.Frame):
    def __init__(self, master):
        ...
        self.img_bg_thongke = ImageTk.PhotoImage(file = "./image/Admin/thongke/thongke.png")
        self.bg_thongke = self.canvas.create_image(750.0, 504.0, image = self.img_bg_thongke)

        # # Bảng filter
        # self.table = ttk.Treeview(self.master, show = 'headings', padding = "20px")
        # style = ttk.Style()
        # style.configure("Treeview", font = ("Tahoma", 10))
        # self.table.place(x = 200, y = 254, height = 500, width = 1100)
        ...
        self.canvas.create_text(550.0, 166.0, anchor = "nw", text = "Thống kê thư viện", fill = "#00054B", font = ("PlayfairDisplay Regular", 50 * -1))
